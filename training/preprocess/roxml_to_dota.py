...
if __name__ == '__main__':
    ...
    roxml_path = r'D:\Desktop_1\wheatear_dataset\labels\roxml'  # 存放roLabelImg标注的原文件的文件夹
    dotaxml_path = r'D:\Desktop_1\wheatear_dataset\labels\dotaxml'  # 存放转换后DOTA数据集xml格式文件的文件夹
    out_path = r'D:\Desktop_1\wheatear_dataset\labels\dotatxt'  # 存放转换后DOTA数据集txt格式文件的文件夹
